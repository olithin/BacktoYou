...
// .wrangler/tmp/pages-ZLi8sr/functionsWorker-0.0387024061558342.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var KEY = "content.bundle.json";
var DEV_TOKEN_HEADER = "X-Dev-Admin-Token";
...
function json(res, status = 200, req, extraHeaders) {
...
function readAccessEmail(req) {
  const raw = req.headers.get("Cf-Access-Authenticated-User-Email") || req.headers.get("cf-access-authenticated-user-email") || "";
  return { rawEmail: raw, email: raw.toLowerCase().trim() };
}
__name(readAccessEmail, "readAccessEmail");
__name2(readAccessEmail, "readAccessEmail");
function readAllowedEmails(env) {
  const listRaw = String(env.ADMIN_EMAILS ?? "");
  return listRaw.split(",").map((s) => s.toLowerCase().trim()).filter(Boolean);
}
__name(readAllowedEmails, "readAllowedEmails");
__name2(readAllowedEmails, "readAllowedEmails");
function findDataImageUrls(value, path = "$") {
  const hits = [];
  const visit = /* @__PURE__ */ __name2((v, p) => {
    if (typeof v === "string") {
      const s = v.trim();
...
__name(findDataImageUrls, "findDataImageUrls");
__name2(findDataImageUrls, "findDataImageUrls");
function isDevBypassEnabled(env) {
  return String(env.DEV_BYPASS_AUTH ?? "").toLowerCase() === "true";
}
__name(isDevBypassEnabled, "isDevBypassEnabled");
__name2(isDevBypassEnabled, "isDevBypassEnabled");
function readDevToken(req) {
  return (req.headers.get(DEV_TOKEN_HEADER) ?? "").trim();
}
__name(readDevToken, "readDevToken");
__name2(readDevToken, "readDevToken");
...
// .wrangler/tmp/bundle-V4nFjc/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-V4nFjc/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.0387024061558342.js.map
